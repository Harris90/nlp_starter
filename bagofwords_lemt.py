# -*- coding: utf-8 -*-
"""
Created on Wed Oct  7 17:08:39 2020
...
print(corpus[0])
print(corpus[5])
#now we have to convert them into vectors with the help of vectorizer

from sklearn.feature_extraction.text import CountVectorizer
count_vect = CountVectorizer()
X_count_vect=count_vect.fit_transform(corpus).toarray()
